...
This sample module contains one small method that filters contigs.
    ...
    def run_akessellContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_akessellContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_akessellContigFilter function. Params=' + pformat(params))
        ...
        #END run_akessellContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_akessellContigFilter return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]

    def run_akessellContigFilter_max(self, ctx, params):
        """
        ...
        # ctx is the context object
        # return variables are: output
        #BEGIN run_akessellContigFilter_max
        ...
        #END run_akessellContigFilter_max

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_akessellContigFilter_max return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]
    def status(self, ctx):
